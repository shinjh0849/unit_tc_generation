...
from parser import DFG_python,DFG_ruby,DFG_go,DFG_php,DFG_javascript,DFG_csharp,DFG_java
...
def corpus_syntax_match(references, candidates, lang):   
    Language.build_library( 'parser/my-languages.so', ['parser/tree-sitter-python', 'parser/tree-sitter-java'])
